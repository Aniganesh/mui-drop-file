...
var MUIDropFile = function (props) {
    ...
    var onDrop = React__default.useCallback(onDropFile, []);
    ...
    return (React__default.createElement(Box, __assign({}, getRootProps(), { border: "0px dashed grey", className: clsx(defaultClass, isDragActive ? activeClass : inactiveClass), display: "flex", alignItems: "center", justifyContent: "center" }),
        React__default.createElement(reactForms.MUIFileInput, { invisible: true, multiple: multiple, inputProps: __assign({}, getInputProps()) })));
};
