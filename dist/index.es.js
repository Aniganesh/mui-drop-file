...
import React, { forwardRef, useImperativeHandle, Fragment as Fragment$1, useRef, useReducer, useCallback, useEffect, useMemo } from 'react';
...
var Dropzone = forwardRef(function (_ref, ref) {
  ...
  return React.createElement(Fragment$1, null, children(_objectSpread({}, props, {
    open: open
  })));
});
...
var MUIDropFile = function (props) {
    ...
    var onDropFile = props.onDropFile, _a = props.multiple, multiple = _a === void 0 ? true : _a, _b = props.defaultClass, defaultClass = _b === void 0 ? classes.defaultClass : _b, _c = props.inactiveClass, inactiveClass = _c === void 0 ? classes.inactiveClass : _c, _d = props.activeClass, activeClass = _d === void 0 ? classes.activeClass : _d;
    var onDrop = React.useCallback(onDropFile, []);
    var _e = useDropzone({ onDrop: onDrop }), isDragActive = _e.isDragActive, getRootProps = _e.getRootProps, getInputProps = _e.getInputProps;
    return (React.createElement(Box, __assign({}, getRootProps(), { border: "0px dashed grey", className: clsx(defaultClass, isDragActive ? activeClass : inactiveClass), display: "flex", alignItems: "center", justifyContent: "center" }),
        React.createElement(MUIFileInput, { invisible: true, multiple: multiple, inputProps: __assign({}, getInputProps()) })));
};
